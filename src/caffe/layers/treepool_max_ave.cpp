...
void TreepoolMaxAveLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void TreepoolMaxAveLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void TreepoolMaxAveLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
  LOG(INFO) << "Enter CPU code ....";
}

template <typename Dtype>
void TreepoolMaxAveLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
      const vector<bool>& propagate_down, const vector<Blob<Dtype>*>& bottom) {
  LOG(INFO) << "Enter CPU code ....";
}

INSTANTIATE_CLASS(TreepoolMaxAveLayer);
REGISTER_LAYER_CLASS(TreepoolMaxAve);
